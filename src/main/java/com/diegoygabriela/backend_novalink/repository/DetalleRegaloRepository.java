...
public interface DetalleRegaloRepository extends JpaRepository<DetalleRegalo, Long> {
    ...
    List<DetalleRegalo> findByRemitenteIdUsuarioOrderByFechaDesc(Long remitenteId);
    
    // Buscar regalos recibidos por un usuario específico
    List<DetalleRegalo> findByReceptorIdUsuarioOrderByFechaDesc(Long receptorId);
    ...
    List<DetalleRegalo> findRegalosBetweenUsers(@Param("usuario1Id") Long usuario1Id, 
