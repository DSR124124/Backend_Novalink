...
import com.diegoygabriela.backend_novalink.securities.JwtResponse;
import com.diegoygabriela.backend_novalink.securities.JwtTokenUtil;
import com.diegoygabriela.backend_novalink.service.impl.JwtUserDetailsService;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody JwtRequest req) throws Exception {
        ...
        Usuario usuario = userDetailsService.getUsuarioByUsername(req.getUsername());
